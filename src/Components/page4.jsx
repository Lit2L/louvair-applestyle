		...
		<div className=' main h-[250vh] w-full '>
				...
				{['Data', 'Informs,', 'Emotion', 'Converts'].map((i, index) => {
					return (
						<div key={index} className='masker '>
							...
							>
								{index === 2 && <span className='inline-block w-32 h-2 bg-black mt-5 '></span>}
								{i}
							</motion.h1>
						</div>
					)
			...
			<div className='content w-full h-[50vh] relative'>
				...
				<p className='paragraph absolute  left-[35%] top-[30%] text-[1.7vw] w-[32vw] leading-[2.5vw] tracking-tight font-[400]'>
					We believe that the most effective outcomes are achieved when data-driven insights are used to inspire emotive
					experiences. Leading to increased brand loyalty, long-term customer engagement, and higher conversion rates.
				</p>
				<p className='lighttext absolute right-[2%] bottom-[-2%] opacity-75 text-sm w-[20vw] py-2 '>
					Lorem ipsum dolor sit amet, <br /> consectetur adipisicing elit. Quam, nostrum mollitia cupiditate labore,
					corrupti excepturi facere modi inventore minus architecto, blanditiis amet sed deserunt! Natus optio pariatur
					dolore tenetur quo. the day, we focus on <br /> making people feel.
				</p>
			</div>
